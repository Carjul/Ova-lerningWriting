...
<br/>
<pre>Pronombres  Traducción  Ejemplo	Traducción</pre>

<pre>I	(Yo) -	I am a teacher - Soy profesor</pre>
<pre>You  (Tú) -	You are a good student	- Tú eres un buen estudiante</pre>
<pre>He	 (Él) -	He is my father - Él es mi padre</pre>
<pre>She (Ella)  -	She is late everyday - Ella llega tarde todos los días</pre>
<pre>It	(Ello / Eso) - It is my house - Es mi casa</pre>
<pre>We	(Nosotros)	-We have two cats - Tenemos dos gatos</pre>
<pre>They	(Ellos) - They are twins - Ellos son gemelos</pre>
<br/>
...
<br/>
<pre>Pronombres 	Traducción	Ejemplo	Traducción</pre>
<pre>Me (me / mí)	Give me that book - Dame ese libro</pre>
<pre>You ( ti / … te)	She loves you -	Ella te ama</pre>
<pre>Him (lo / … se / … él)	 Just help him -	Solo ayúdalo</pre>
<pre>Her (la / … se / … ella)	The email is for her - El correo electrónico es para ella</pre>
<pre>It	(lo / ... se)	I'll think about it	- Lo pensaré</pre>
<pre>Us	(nos / … nosotros)	Can you see us?	- ¿Nos puedes ver?</pre>
<pre>Them (los / … ellos)	Did you talk to them? -	¿Hablaste con ellos?</pre>
<br/>
...
<br/>
<pre>Pronombres posesivos 	Traducción	Ejemplo	Traducción</pre>
<pre>Mine (… mío)  This coat is mine  -	Este abrigo es mío</pre>
<pre>Yours (... tuyo)	These keys are yours -	Estas llaves son tuyas</pre>
<pre>His (… de él / … suyo /de él)	This phone is his -	Este teléfono es suyo</pre>
<pre>Hers (… de ella / … suyo / de ella)	My notebook is old, hers is new  -	Mi cuaderno es viejo, el de ella es nuevo</pre>
<pre>Ours (… nuestro)	That red truck is going to be ours -	Ese camión rojo va a ser nuestro</pre>
<pre>Theirs	(suyo /de ellos)	My apartment is here, theirs is  there -	Mi apartamento está aquí, el de ellos allá</pre>
<br/>
